...
<ul class=green10>
	...
	<li>Puzzles are randomly generated. Most, but probably not all, can be solved down to 0 tiles.</li>
</ul>
    ''')
...
#s = Shanghai()
#s.setUpScript('106932376942135580175')